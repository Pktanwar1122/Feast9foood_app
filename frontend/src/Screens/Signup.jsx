...
import deliveryboyimage from "../assets/delivery boy 2.avif"
...
const Signup = () => {
  ...
  return (
    <div className="h-screen w-full  flex justify-center items-center ">
      <div className="h-full w-2/4 mt-48  flex justify-end items-center">
        <form
          className="flex justify-center  items-center mb-12  flex-col "
          onSubmit={handleSubmit}
        >
        <h1  className=" mb-10 text-3xl">Signup Form:</h1>
        <div className=" flex">
            <label className="text-2xl border-b border-black">FullName:</label>
            <input
              placeholder="eg. john Doe"
              className=" text-black h-10 w-full max-w-xs border-b border-black"
              type="email"
              name="name"
            />
          </div>
          <br />
          <div className=" flex">
            <label className="text-2xl border-b border-black">Username:</label>
            <input
          ...
          <div className=" flex" >
            <label className="text-2xl flex border-b border-black">Password: </label>
            <input
              placeholder="    ***********"
              className=" text-black h-10 w-full max-w-xs border-b border-black"
              type="password"
          ...
          <div className="flex justify-center items-center flex-col">
            ...
            <Link to={"/login"}>
            <button
              className="border border-black bg-blue-400 font-bold rounded-md  px-4 py-1 mb-2"
              type="submit"
            >
              Signup
            </button>
            ...
            <Link to={"/login"}>
            <button
              className="border font-bold mb-1 flex gap-2 rounded-md  border-black bg-blue-400 px-4 py-1"
              type="submit"
            >
              <svg
                data-name="Layer 1"
      ...
      <div className=" h-full w-2/4 mt-44">
      <div className="flex justify-center  items-center flex-col" >
      <img className=" mt-20" src={deliveryboyimage} ></img> 
      </div>
      </div>
